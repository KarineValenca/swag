...
BINARY_NAME:=swag
PACKAGES:=$(shell $(GOLIST) github.com/KarineValenca/swag github.com/KarineValenca/swag/cmd/swag github.com/KarineValenca/swag/gen github.com/KarineValenca/swag/format)
...
.PHONY: deps
deps:
	$(GOGET) github.com/KarineValenca/cli

...
Or download a pre-compiled binary from the [release page](https://github.com/KarineValenca/swag/releases).
...
Find the example source code [here](https://github.com/KarineValenca/swag/tree/master/example/celler).
...
Find the result of formatting [here](https://github.com/KarineValenca/swag/tree/master/example/celler).
...
[#708](https://github.com/KarineValenca/swag/issues/708) The parser handles only struct comments starting with `@Description` attribute.
